...
<nav class="navbar navbar-fixed-top">
  <div class="container-fluid " style="position: absolute; margin-left: 85px;">
    ...
    <li><img src="img/logokecil.png"  width="50px" height="50px" style="margin-left: 40px; margin: 1px; padding: 0px"></li>
    </ul></b>
  </div>
</nav>
...
<div id="beranda">
<div class="tampilan">
  <img src="img/logo.png" alt="" width="60px" style="position: absolute; border-radius: 30px; margin-left: 84%; margin-top: -30px;">
  <img class="img-mimbar"src="img/mimbar.jpeg" alt="mimbar" >
  <div class="card-beranda">
    <div class="cardd">
    <img src="img/icon-leave.png" alt="" width="30px" height="30px" style="margin-right: 9px;"><h6>Lingkungan<br>Terjaga.</h6>
    </div>
    <div class="cardd" style="margin-top: 15px">
    <img src="img/icon-panah.png" alt="" width="30px" height="30px" style="margin-right: 9px;"> <h6>Kapasitas<br>Besar.</h6>
    </div>
    <div class="cardd" style="margin-top: 15px">
    <img src="img/icon-quran.png" alt="" width="30px" height="30px" style="margin-right: 9px;"><h6>Al-Qur'an<br>Hadist</h6>
    </div>
  </div>
...
<div class="card text-center"style="max-width: 65rem; margin-top: 80px; margin-left: 8%;">
  <div class="card-body">
  <div class="d-flex justify-content-between" >
    <div class="data-donatur"><p>Total Target Dana</p>
    ...
    <div class="data-donatur"><p>Total Donatur</p>
  ...
  <div class="row">
      ...
      <div class="col-4">
          <b><span style="font-size: 30px; color:darkblue;">
                 <?php echo $koneksi->persentase(); ?>% </span> <span style="font-size: 30px; color:darkblue;">Terpenuhi</span></b>
       </div>
  </div>

  <div class="prog-donatur" style="background-color: #1F3984; height: 50px; display: jutify; margin-top: 30px;">
...
<!-- CARD-->
<img class="img-manfaat" src="img/tangan.jpeg" style="max-width: 350px; float: right; margin-right: 100px; border-radius: 20px" height="800px">
<!-- card 2 -->
<div class="card2" style="margin-left: 12px;">
<div class="card text-bg-light mb-3" style="max-width: 16rem; margin-left: 11%" height="70px">
  <div class="header" style="margin-top: 20px; margin-left: 20px">
    <div class="icon-bc" style="background:rgba(31, 57, 132, 0.15); height:60px; width:60px; border-radius:100px;">
...
<div class="card text-bg-light mb-3" style="max-width: 16rem; margin-left: 50px" height="70px">
    <div class="header" style="margin-top: 20px; margin-left: 20px">
    <div class="icon-bc" style="background:rgba(31, 57, 132, 0.15); height:60px; width:60px; border-radius:100px;">
...
<div class="manfaat" style="margin-top: 100px;">
    ...
    <p style="margin-bottom: 60px;"><b>Berikut Adalah Cara Melakukan Waqaf, Infaq, Shadaqoh Unruk<br>Membantu Pembangunan Masjid Besar SMK Bogor</b></p>
</div>
<!-- card 4 -->
<div class="card-all">
<div class="card4">
<div class="card text-bg-light mb-3" style="max-width: 30rem; margin-left: 8%" height="55px">
    <div class="header" style="margin-top: 20px; margin-left: 20px">
...
<div class="card text-bg-light mb-3" style="max-width: 30rem; margin-left: 50px" height="55px">
    <div class="header" style="margin-top: 20px; margin-left: 20px">
...
<footer class="footer-main" style="margin-top: 100px;">
      <div class="footer-grid">
        <section class="footer1">
          <ul class="nav navbar-nav" >
          <li style="display: flex;"><img class="image" src="logokecil.png"  width="50px" height="50px" style="margin: 0px; padding: 0px ">SMK WIKRAMA <br>BOGOR</li>          
          </ul></br>
           <h6><b>Alamat</b></h6>
            <p>Jl.Raya Wangun <br>
